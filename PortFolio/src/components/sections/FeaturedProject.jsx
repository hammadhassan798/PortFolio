...
export default function FeaturedProject() {
  return (
    <section
      id="projects"
      className="py-36 bg-white relative overflow-hidden"
    >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-14">
            ...
            <a
              ...
              className="px-8 py-4 rounded-full bg-[#18181B] text-white flex items-center gap-2 hover:bg-[#B98B43] duration-300"
            >
              Live Demo
              <HiArrowTopRightOnSquare/>
            </a>
